...
| [US Phone Numbers](#us-phone-numbers) | Planned | Diagnosed: unregistered 10DLC (`30034`). A2P campaign **FAILED** 2026-09-05 (`30908` + `30893`) — `docs/a2p-registration.md`. |
...
- 2026-09-05: privacy page now carries the TCR non-sharing clause and names Shared Events / Ramsey Kilani; sample 1 + Auth `sms_template` become `Shared Events: [code] is your sign-in code. Reply STOP to opt out.` Resubmit the same SID after the production evidence URL is live.
