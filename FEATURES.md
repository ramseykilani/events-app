...
- Desktop polish (owner-approved 2026-09-03, after the production deploy of the pull-ins): the mock grows to 480px so the product shot carries the hero's right column, everything below the hero shares one 760px measure (beta / How it works / footer align on the same edges), and the hero takes the candidate's 56/72px vertical rhythm. Mobile is untouched — phone viewports never reach the mock cap.
