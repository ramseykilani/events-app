...
| [US Phone Numbers](#us-phone-numbers) | Planned | Diagnosed: unregistered 10DLC (`30034`). A2P campaign **IN_PROGRESS** (resubmission #4, 2026-09-05: brand-named sample 1 + dedicated policy URLs) — `docs/a2p-registration.md`. |
