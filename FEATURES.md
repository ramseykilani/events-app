...
| [US Phone Numbers](#us-phone-numbers) | Planned | Diagnosed: unregistered 10DLC (`30034`). A2P campaign **IN_PROGRESS** (resubmitted 2026-09-04) — `docs/a2p-registration.md`. |
...
**Status:** Planned — diagnosed 2026-08-17 (unregistered 10DLC; see first Open Questions bullet). The fix is A2P registration, not app logic: brand approved + verified 2026-08-17; campaign rejected 2026-08-19 on CTA evidence (TCR 30909). Owner approved the consent-line fix 2026-09-04; the line shipped to production the same day; campaign `QE2c6890da8086d771620e9b13fadeba0b` resubmitted 2026-09-04 and is **IN_PROGRESS** (automated check passed; TCR human review). US-bound SMS stays blocked (`30034`) until approval. State + playbook: `docs/a2p-registration.md` and `STATUS.md` → A2P 10DLC registration. Recorded 2026-08-16 from internal testing.
...
- 2026-09-04: consent line live on production; owner resubmitted the same campaign SID (message_flow quotes the on-screen line; sample 2 refreshed). Live status **IN_PROGRESS**. Full state and playbook: `docs/a2p-registration.md`; live table: `STATUS.md` → A2P 10DLC registration.
