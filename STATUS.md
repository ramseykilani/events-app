...
| production (Play internal / TestFlight) | — | — | — | Not started — waits on the full owner smoke pass (`manual-tests/native_device_smoke.md`), then Play identity verification for submit. |
