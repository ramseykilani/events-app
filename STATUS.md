...
|---------|----------|------|------|-------|
| production (Play internal) | Android | 2026-08-25 | https://expo.dev/accounts/rkilani/projects/events-app/builds/a32e3971-27b5-4c1a-904b-172e8d4a8d83 | **Copy + Follow cutover build, second pair** — includes the today-dot fix the release review forced (the first pair predated it; spec cutover step 4 accepts a second pair for a fix-forward). 0.1.0 / versionCode **6**. Submit https://expo.dev/accounts/rkilani/projects/events-app/submissions/54fb43d2-f188-4770-9135-d7ead612a77b succeeded. AAB https://expo.dev/artifacts/eas/QORH_ppxTK16ba_e-S8ws_NoskqSbujgINlS279DUvk.aab |
| production (TestFlight) | iOS | 2026-08-25 | https://expo.dev/accounts/rkilani/projects/events-app/builds/55056996-dce4-4b90-aeba-7e0828660a41 | **Copy + Follow cutover build, second pair** (same reason). 0.1.0 / build **7**. Submitted to App Store Connect (group **Team (Expo)**); Apple processing. IPA https://expo.dev/artifacts/eas/kjEQH1SHiGON2pTHisrDpB7AErVBX5IIEy_pnkNAcig.ipa |
