...
| production (Play internal) | Android | 2026-08-18 | https://expo.dev/accounts/rkilani/projects/events-app/builds/d0dd7f05-75a6-4159-a9dd-adfcf8cd26e0 | **On the internal track.** 0.1.0 / versionCode **4** from promoted `78b9e5a`. Submit https://expo.dev/accounts/rkilani/projects/events-app/submissions/f1e6ef2d-bc10-4b18-a103-5b0320dff6a9 succeeded. AAB https://expo.dev/artifacts/eas/oOhGNk3kja1mJfOW53yljzoWT9JzDAiglUBNe-BwoVE.aab. Play Console → Testing → Internal testing → copy the opt-in link (Play does not email testers). |
| production (TestFlight) | iOS | 2026-08-18 | https://expo.dev/accounts/rkilani/projects/events-app/builds/62920fb6-d632-49d4-97ec-b0dcdc3bbb1f | **Uploaded to App Store Connect.** 0.1.0 / build **4** from promoted `78b9e5a`. Submit https://expo.dev/accounts/rkilani/projects/events-app/submissions/4e41e2c9-fe3e-4521-90a1-06a0949fd2d4 succeeded (group **Team (Expo)**). Apple processing ~5–10 min; then https://appstoreconnect.apple.com/apps/6801756936/testflight/ios. **No Beta App Review.** IPA https://expo.dev/artifacts/eas/Oh0DzvTC7Xt1u2arZ85KI83tsRFm2RT33JhNGXXusfA.ipa |
